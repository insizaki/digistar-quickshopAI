...
CHATBOT_TEMPLATE = """Kamu adalah asisten yang membantu pengguna dengan informasi tentang produk. 

Berikut adalah data produk:
- Nama Produk: {product_name}
- Deskripsi: {description}
- Total Ulasan: {review_count}
- Sentimen Positif: {positive_count}
- Sentimen Netral: {neutral_count}
- Sentimen Negatif: {negative_count}
...
Berdasarkan informasi produk di atas, berikan jawaban yang membantu dan informatif dalam bahasa Indonesia."""
